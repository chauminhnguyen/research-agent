    ...
    try {
      ...
      if (showSecondFactor) {
        ...
        if (result.status === "complete") {
          ...
          setError("Two-factor verification incomplete. Please try again.");
        }
        return;
      }
      ...
      <Card className="w-full max-w-md shadow-float">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-semibold tracking-tight">
            {showSecondFactor ? "Two-Factor Verification" : "Welcome back"}
          </CardTitle>
          <CardDescription>
            {showSecondFactor 
            ...
            <>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-canvas-soft px-2 text-body">Or continue with email</span>
                </div>
              </div>
            </>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {showSecondFactor ? (
              <>
                ...
                <Button type="submit" className="w-full rounded-pill" size="lg" disabled={!isLoaded || isLoading || code.length < 6}>
                ...
                <button
                  type="button"
                  onClick={handleBack}
                  className="w-full text-sm text-link hover:underline"
                >
                  Back to sign in
                </button>
              </>
              ...
              <>
                ...
                <Button type="submit" className="w-full rounded-pill" size="lg" disabled={!isLoaded || isLoading}>
